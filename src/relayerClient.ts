...
import { buildSafeTransactionRequest, executeSafeWithUsdcApproval, aggregateTransaction } from "./createSafeTransaction";
...
import type { SafeContractConfig, SafeTransaction, SafeTransactionArgs, TransactionRequest } from "./types";
...
export interface IRelayerClient {
    ...
    sendTransactionSync(params: SendTransactionParams): Promise<TransactionReceipt>;
}
    ...
    async sendTransactionSync(params: SendTransactionParams): Promise<TransactionReceipt> {
            ...
            return this._gelato.sendTransactionSync(
                {
                    ...
                    ...(params.authorizationList != null && { authorizationList: params.authorizationList as import("viem").SignedAuthorizationList }),
                },
        ...
        if (this.relayer === "backend") {
            const body = {
                ...
                to: params.to,
                data: params.data,
                ...(params.authorizationList != null && { authorizationList: params.authorizationList }),
